...
Welcome to `mnist_trainer` contributor's guide.
...
If you experience bugs or general issues with `mnist_trainer`, please have a look
...
You can help improve `mnist_trainer` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`mnist_trainer` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `mnist_trainer`'s files. While this mechanism can
...
```
conda create -n mnist_trainer python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/mnist_trainer.git
   cd mnist_trainer
   ```
...
5. Install [pre-commit]:
   ...
   `mnist_trainer` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/mnist_trainer
[issue tracker]: https://github.com/<USERNAME>/mnist_trainer/issues
